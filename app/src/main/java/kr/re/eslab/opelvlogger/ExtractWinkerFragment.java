...
public class ExtractWinkerFragment extends ExtractFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        drawableArrayList.add(0,R.drawable.extract_winker_off);
        drawableArrayList.add(1,R.drawable.extract_winker_left_on);
        drawableArrayList.add(2,R.drawable.extract_winker_right_on);

        noticeArrayList.add(0,"양쪽 방향지시등을 켜지않고\n 화면을 터치하세요");
        noticeArrayList.add(1,"왼쪽 방향지시등을 킨 후\n 화면을 터치하세요");
        noticeArrayList.add(2,"오른쪽 방향지시등을 킨 후\n 화면을 터치하세요");

        String message = "EXTRACT 1 0 "+ extract_state_Count;
